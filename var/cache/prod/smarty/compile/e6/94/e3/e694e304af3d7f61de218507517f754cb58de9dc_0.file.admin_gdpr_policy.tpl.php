...
/* Smarty version 3.1.33, created on 2020-12-10 18:47:11
  from '/home/legion/serwerphp/centrummateracy/modules/supercheckout/views/templates/admin/admin_gdpr_policy.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.33',
  'unifunc' => 'content_5fd25f1feebdc8_64410497',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'e694e304af3d7f61de218507517f754cb58de9dc' => 
    array (
      0 => '/home/legion/serwerphp/centrummateracy/modules/supercheckout/views/templates/admin/admin_gdpr_policy.tpl',
      1 => 1607622422,
      2 => 'file',
    ),
  ),
...
function content_5fd25f1feebdc8_64410497 (Smarty_Internal_Template $_smarty_tpl) {
?><!--------------- Start - GDPR Changes -------------------->
...
"></i>
                                ...
                                <td class="supercheckout_popup_form_field">
                                    <div class="" style="margin-left:10px">
                                            ...
                                            <?php if (is_array($_smarty_tpl->tpl_vars['available_cms']->value) && !empty($_smarty_tpl->tpl_vars['available_cms']->value)) {?>
                                                <?php
$_from = $_smarty_tpl->smarty->ext->_foreach->init($_smarty_tpl, $_smarty_tpl->tpl_vars['available_cms']->value, 'cms_page');
if ($_from !== null) {
foreach ($_from as $_smarty_tpl->tpl_vars['cms_page']->value) {
?>
                                                    <option value="<?php echo $_smarty_tpl->tpl_vars['cms_page']->value['id_cms'];?>
"><?php echo $_smarty_tpl->tpl_vars['cms_page']->value['meta_title'];?>
 </option>
                                                <?php
}
}
    ...
    <div class="block">
        ...
        <div>
            <table class="form">
                <tbody>
                                                                <tr>
                                    <td class="name vertical_top_align"><span class="control-label"><?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'Enable Delete From Email Marketing Services on request','mod'=>'supercheckout'),$_smarty_tpl ) );?>
: </span>                                                                
                                        <i class="icon-question-sign supercheckout-tooltip-color" data-toggle="tooltip"  data-placement="bottom" data-original-title="<?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'Enable to delete customer email From Email Marketing Services (MailChimp, SendinBlue & Klaviyo) on request','mod'=>'supercheckout'),$_smarty_tpl ) );?>
"></i>
                                    </td>
                                    <td class="settings">
                                        <input type="hidden" value="0" name="velocity_supercheckout[email_marketing_delete]" />
                                        <?php if ($_smarty_tpl->tpl_vars['velocity_supercheckout']->value['email_marketing_delete'] == 1) {?>
