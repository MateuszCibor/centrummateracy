...
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.33',
  'unifunc' => 'content_5fd25f2a9f2396_18312662',
...
function content_5fd25f2a9f2396_18312662 (Smarty_Internal_Template $_smarty_tpl) {
...
?>
 ...
 <?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'Reviews','d'=>'Modules.Iqitreviews.Product-reviews'),$_smarty_tpl ) );?>

            </div>
            <?php } else { ?>
            <div id="iqitreviews-snippet"><?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'No reviews','d'=>'Modules.Iqitreviews.Product-reviews'),$_smarty_tpl ) );?>
</div>
            <?php }?>
        </div>
            ...
            <div class="col col-auto mb-3">
                <button type="button" class="btn btn-primary " data-toggle="modal"
                    ...
                    <i class="fa fa-pencil-square-o"
                       aria-hidden="true"></i> <?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'Write  review','d'=>'Modules.Iqitreviews.Product-reviews'),$_smarty_tpl ) );?>
...
"/>
                ...
                <div class="comment" itemprop="reviewBody"><?php echo nl2br($_smarty_tpl->tpl_vars['review']->value['comment']);?>
</div>

                <div class="author">
                   <span itemprop="author" itemscope itemtype="https://schema.org/Person"><?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'By','d'=>'Modules.Iqitreviews.Product-reviews'),$_smarty_tpl ) );?>
 <span itemprop="name"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['review']->value['customer_name'], ENT_QUOTES, 'UTF-8');?>
</span></span>

                    <?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'on','d'=>'Modules.Iqitreviews.Product-reviews'),$_smarty_tpl ) );?>
...
"
                    ...
                    <div class="modal-header">
                        <span class="modal-title"><?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'Write a review','d'=>'Modules.Iqitreviews.Product-reviews'),$_smarty_tpl ) );?>
</span>
...
"/>
                            ...
                            <?php if (!$_smarty_tpl->tpl_vars['isLogged']->value) {?>
                                <div class="form-group row">
                                    <label class="col-md-3 form-control-label"><?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'Name','d'=>'Modules.Iqitreviews.Product-reviews'),$_smarty_tpl ) );?>
</label>
                                    <div class="col-md-6">
                                        <input type="text" class="form-control" name="iqitreviews_customer_name"
                                               id="iqitreviews_customer_name" value=""
                                               placeholder="<?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'John Doe','d'=>'Modules.Iqitreviews.Product-reviews'),$_smarty_tpl ) );?>
"/>
                                    </div>
                                </div>
                            <?php }?>
                            ...
                            <div class="form-group row">
                                <label class="col-md-3 form-control-label"><?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'Title','d'=>'Modules.Iqitreviews.Product-reviews'),$_smarty_tpl ) );?>
</label>
                                <div class="col-md-6">
                                    <input type="text" class="form-control" name="iqitreviews_title"
                                           id="iqitreviews_title" value=""
                                           placeholder="<?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'Ex. Very good','d'=>'Modules.Iqitreviews.Product-reviews'),$_smarty_tpl ) );?>
"/>
                                </div>
                            </div>

                            <div class="form-group row">
                                <label class="col-md-3 form-control-label"><?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'Rating','d'=>'Modules.Iqitreviews.Product-reviews'),$_smarty_tpl ) );?>
</label>
                                <div class="col-md-6">
                            ...
                            <div class="form-group row">
                                <label class="col-md-3 form-control-label"><?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'Comment','d'=>'Modules.Iqitreviews.Product-reviews'),$_smarty_tpl ) );?>
</label>
                                <div class="col-md-6">
                                         <textarea class="form-control" rows="3" name="iqitreviews_comment"
                                                   id="iqitreviews_comment"
                                                   placeholder="<?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'Write your opinion about product','d'=>'Modules.Iqitreviews.Product-reviews'),$_smarty_tpl ) );?>
"></textarea>
                                </div>
                            </div>
                    ...
                    <div class="modal-footer">
                        <input class="btn btn-primary" type="submit" name="iqitreviews_submit"
                               ...
                               value=" <?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'Submit review','d'=>'Modules.Iqitreviews.Product-reviews'),$_smarty_tpl ) );?>
">
                    </div>
                </form>
            </div>
