...
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.33',
  'unifunc' => 'content_5fd25f2acad051_08851442',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '20471086401eb99f3dff6347c154f72663a6cb3d' => 
    array (
...
function content_5fd25f2acad051_08851442 (Smarty_Internal_Template $_smarty_tpl) {
...
<nav id="cbp-hrmenu1" class="cbp-hrmenu  iqitmegamenu-all cbp-vertical <?php if (!isset($_smarty_tpl->tpl_vars['ontop']->value)) {?>cbp-not-on-top<?php }?>">
	<div class="cbp-vertical-title"><i class="fa fa-bars cbp-iconbars"></i> <span class="cbp-vertical-title-text"><?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'Navigation','mod'=>'iqitmegamenu'),$_smarty_tpl ) );?>
</span></div>
...
?>
 ...
 <?php if ((isset($_smarty_tpl->tpl_vars['__smarty_foreach_innertabsnames']->value['first']) ? $_smarty_tpl->tpl_vars['__smarty_foreach_innertabsnames']->value['first'] : null)) {?>active<?php }?>"><a data-target="#iq-<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['innertab']->value->id, ENT_QUOTES, 'UTF-8');?>
...
?>
													<?php $_smarty_tpl->_subTemplateRender("module:iqitmegamenu/views/templates/hook/_partials/submenu_content.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, $_smarty_tpl->cache_lifetime, array('node'=>$_smarty_tpl->tpl_vars['element']->value), 0, true);
?>
												<?php
}
}
...
<?php if (isset($_smarty_tpl->tpl_vars['mobile_menu_v']->value)) {?>
<div id="_desktop_iqitmegamenu-mobile">
	<ul id="iqitmegamenu-mobile">
		<?php $_smarty_tpl->_subTemplateRender("module:iqitmegamenu/views/templates/hook/_partials/mobile_menu.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, $_smarty_tpl->cache_lifetime, array('menu'=>$_smarty_tpl->tpl_vars['mobile_menu_v']->value), 0, false);
?>
	</ul>
</div>
<?php }
