...
class IqitHtmlAndBannerRepository
{
    ...
    {
        $usableHooks = ['displayFooter', 'displayCheckoutFooter', 'displayFooterBefore', 'displayFooterProduct', 'displayFooterAfter', 'displayLeftColumn', 'displayRightColumn',  'displayWrapperTopInContainer', 'displayWrapperTop', 'displayNavCenter', 'displayWrapperBottom', 'displayWrapperBottomInContainer', 'displayMyAccountDashboard', 'displayReassurance', 'displayRightColumnProduct', 'displayAfterProductThumbs2', 'displayNav1', 'displayNav2', 'displayProductAdditionalInfo', 'displayTop', 'displayNavFullWidth', 'displayBelowHeader'];
    ...
    public function getDisplayHooksForHelperBanner()
    {
        ...
        $usableHooks = ['displayFooter', 'displayCheckoutFooter', 'displayFooterBefore','displayFooterProduct', 'displayFooterAfter', 'displayLeftColumn', 'displayRightColumn',   'displayWrapperTopInContainer', 'displayWrapperTop', 'displayWrapperBottom', 'displayWrapperBottomInContainer',  'displayMyAccountDashboard',  'displayReassurance', 'displayRightColumnProduct', 'displayAfterProductThumbs2', 'displayBanner', 'displayProductAdditionalInfo', 'displayTop', 'displayNavFullWidth', 'displayBelowHeader'];
