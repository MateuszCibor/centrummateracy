<div class="post-item">
    ...
    {if Configuration::get('PH_BLOG_DISPLAY_THUMBNAIL') && (isset($post.banner_wide) || isset($post.banner_thumb))}
        <div class="post-thumbnail">
            <a href="{if $post.post_type == 'url'}{$post.external_url}{else}{$post.url}{/if}">
    ...
    {if Configuration::get('PH_BLOG_DISPLAY_DESCRIPTION')}
        <div class="post-content">
            ...
            {if Configuration::get('PH_BLOG_DISPLAY_MORE')}
                <a href="{if $post.post_type == 'url'}{$post.external_url}{else}{$post.url}{/if}" title="{l s='Read more' mod='ph_simpleblog'}" class="post-read-more text-muted">
