...
class Widget_Image_Carousel extends Widget_Base {
	...
	protected function _register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'show_label' => false,
				'selectors' => [
					'{{WRAPPER}} .slick-list' => 'margin-left: -{{SIZE}}{{UNIT}}; margin-right: -{{SIZE}}{{UNIT}}; padding-right: {{SIZE}}{{UNIT}};',
	...
	protected function render( $instance = [] ) {
		...
		if ( ! $is_slideshow ) {
			$slick_options['slidesToScroll'] = \IqitElementorWpHelper::absint( $instance['slides_to_show']);
		} else {
