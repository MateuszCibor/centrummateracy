...
class Widget_Instagram extends Widget_Base {
    ...
    protected function _register_controls() {
        ...
        $this->add_control(
            'instagram_type',
            [
                'label' => \IqitElementorWpHelper::__( 'Feed source ', 'elementor' ),
                'type' => Controls_Manager::SELECT,
                'section' => 'section_instagram',
                'options' => [
                    'user' => \IqitElementorWpHelper::__( 'User', 'elementor' ),
                    'tag' => \IqitElementorWpHelper::__( 'Tag', 'elementor' ),
                ],
                'default' => 'user',
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'section' => 'section_instagram',
                'placeholder' => \IqitElementorWpHelper::__( 'Enter your username', 'elementor' ),
                'default' => 'instagram',
                'label_block' => true,
                'condition' => [
                    'instagram_type' => 'user',
        ...
        $this->add_control(
            'instagram_tag',
            [
                'label' => \IqitElementorWpHelper::__( 'Tag', 'elementor' ),
                'type' => Controls_Manager::TEXT,
                'section' => 'section_instagram',
                'placeholder' => \IqitElementorWpHelper::__( 'Enter your username', 'elementor' ),
                'label_block' => true,
        ...
        $this->add_control(
            'instagram_limit_user',
            [
                'label' => \IqitElementorWpHelper::__( 'Limit', 'elementor' ),
                'type' => Controls_Manager::NUMBER,
                'description' => \IqitElementorWpHelper::__( 'An integer that indicates the amount of photos to be feed. Instagram Api allow 12 as maxiumum for users', 'elementor' ),
                'min' => 1,
                'max' => 12,
                'default' => 10,
                'section' => 'section_instagram',
        ...
        $this->add_control(
            ...
            [
                'label' => \IqitElementorWpHelper::__( 'Limit', 'elementor' ),
                'type' => Controls_Manager::NUMBER,
                'description' => \IqitElementorWpHelper::__( 'An integer that indicates the amount of photos to be feed. Instagram Api allow 72 as maximum for tags', 'elementor' ),
                'min' => 1,
                'max' => 72,
                'default' => 10,
                'section' => 'section_instagram',
        ...
        $this->add_control(
            ...
            [
                ...
                'section' => 'section_instagram',
                'options' => [
                    '150' => \IqitElementorWpHelper::__( '150px', 'elementor' ),
                    '240' => \IqitElementorWpHelper::__( '240px', 'elementor' ),
                    '320' => \IqitElementorWpHelper::__( '320px', 'elementor' ),
                    '480' => \IqitElementorWpHelper::__( '480px', 'elementor' ),
                    '640' => \IqitElementorWpHelper::__( '640px', 'elementor' ),
                ],
                'default' => '320',
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => Controls_Manager::SELECT,
                'section' => 'section_instagram',
                'description' => \IqitElementorWpHelper::__( 'Show info like comments and  likes  on hover', 'elementor' ),
                'options' => [
                ...
                'default' => 'none',
                'selectors' => [
                    '{{WRAPPER}} .il-item-inner .il-photo__metainner' => 'display: {{VALUE}};',
                ],
    ...
    protected function render( $instance = [] ) {
        ...
        if ($instance['instagram_view'] == 'grid') {
            ...
            $instagram_options = [
                ...
                'tag' => $instance['instagram_tag'],
                'type' => $instance['instagram_type'],
                'limit_user' => $instance['instagram_limit_user'],
                'limit_tag' => $instance['instagram_limit_tag'],
                'linked' => ( 'yes' === $instance['instagram_linked'] ),
                'class' => $class,
                'image_size' => $instance['instagram_size'],
            ];
